      ...
      <header class="navbar d-block navbar-sticky navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand d-none d-sm-block me-4 order-lg-1" href="../index.php"><img src="../img/unnmarketplace.png" width="142" alt="Admin"></a><a class="navbar-brand d-sm-none me-2 order-lg-1" href="../index.php"><img src="../img/unnmarketplace.png" width="74" alt="UNNMarketplace"></a>
      ...
      <div class="page-title-overlap bg-accent pt-4">
        <div class="container d-flex flex-wrap flex-sm-nowrap justify-content-center justify-content-sm-between align-items-center mb-2 pt-2">
          <div class="d-flex align-items-center">
            <div class="img-thumbnail rounded-circle position-relative flex-shrink-0" style="width: 6.375rem;"><img class="rounded-circle" src="../profile_image/<?php echo safe($userimage) ?? "logo.png"; ?>" alt="@amin"></div>
            <div class="ps-3">
              <h3 class="h5 mb-2 text-light">@Admin</h3><span class="d-block text-light fs-sm opacity-60">Joined <?php echo date('M j',strtotime($admindate)); ?></span>
            </div>
          </div>
